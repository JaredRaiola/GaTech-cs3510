...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
{\bf \noindent Homework 2. \\ Due: Thursday, February 6, 2020 before lecture via Gradescope.}

\begin{problem}{[DPV] Problem 6.1 -- Maximum sum}
...
\begin{problem}{[DPV] Problem 6.8 --  Longest common substring}
...
\begin{problem}{[DPV] Problem 6.19 -- Making change k}
...
\begin{problem}{(The thief's plan)}
